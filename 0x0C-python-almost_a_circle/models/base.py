...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """It  converts dictionary to json """
    ...
    def save_to_file(cls, list_objs):
        """it  writes the JSON string representation to file """
        LO_dict = []
    ...
    def create(cls, **dictionary):
        """It create an instance of the class and return it """
    ...
    def draw(list_rectangles, list_squares):
        """It draw list of rec ands squares """
