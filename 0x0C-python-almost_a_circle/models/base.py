...
class Base:
    """ Base class with utility methods for managing geometric shapes """
    __nb_objects = 0

    def __init__(self, id=None):
        """ Initializes the Base class instance with an optional ID """
        if id is None:
    ...
    def draw(list_rectangles, list_squares):
        """ Draws a list of rectangles and squares using the turtle module """
